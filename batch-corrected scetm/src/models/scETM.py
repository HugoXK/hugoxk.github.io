...
class scETM(BaseCellModel):
    ...
    def __init__(self,
        ...
        hidden_sizes: Sequence[int] = (128,2),
        bn: bool = True,
    ...
    def forward(self,
        ...
        # loss = nll*nll + (hyper_param_dict['kl_weight'] * kl_delta)*(hyper_param_dict['kl_weight'] * kl_delta)
        
        # loss = abs(nll+ hyper_param_dict['kl_weight'] * kl_delta)
        loss = torch.abs(nll + (hyper_param_dict['kl_weight'] * kl_delta))
